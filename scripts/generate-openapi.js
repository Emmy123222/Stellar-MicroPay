    ...
    properties: {
      ...
      sent: {
        ...
        properties: {
          ...
          totalXLM: { type: "string" },
          counterparties: { $ref: "CohortCounterpartySummary" },
        },
      },
      received: {
        type: "object",
...
const PATHS = {
  ...
  "/api/accounts/{publicKey}": {
    get: {
      ...
      responses: {
        ...
        403: { description: "Forbidden: can only access own account" },
  ...
  "/api/analytics/{publicKey}/export-schedule": {
    ...
    post: {
      ...
      requestBody: {
        ...
        content: {
          "application/json": {
            schema: { $ref: "ExportScheduleRequest" },
          },
        },
      },
      responses: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  data: {
                    type: "array",
                    items: { $ref: "TxFunctionDeployment" },
                  },
                },
              },
            },
  ...
  "/api/turrets/challenge": {
    post: {
      ...
      description:
        "Returns a ManageData transaction XDR that the user must sign with their Stellar keypair to prove ownership.",
      requestBody: {
        required: true,
        content: {
          "application/json": {
            schema: { $ref: "TxFunctionChallengeRequest" },
          },
        },
      },
      responses: {
          ...
          content: {
            "application/json": {
              schema: {
                ...
                properties: {
                  success: { type: "boolean", example: true },
                  data: { $ref: "TxFunctionChallengeResponse" },
                },
              },
            },
          },
  ...
  "/api/turrets/deploy": {
    post: {
      ...
      requestBody: {
        ...
        content: {
          "application/json": {
            schema: { $ref: "TxFunctionDeployRequest" },
          },
        },
      },
      responses: {
    ...
    post: {
      ...
      responses: {
        201: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "WebhookRegistrationResponse" },
            },
          },
        },
        400: { description: "Invalid request body" },
    ...
    get: {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "WebhookListResponse" },
            },
          },
        },
        429: { description: "Rate limit exceeded" },
    ...
    for (const [key, value] of Object.entries(obj)) {
      if (key === "$ref" && typeof value === "string") {
        ...
        if (SCHEMAS[schemaName]) {
          return resolveRefs(JSON.parse(JSON.stringify(SCHEMAS[schemaName])));
        }
      }
...
function generateOpenApiSpec() {
  const resolvedPaths = resolveRefs(PATHS);
...
function main() {
  ...
  const outputPath =
    process.env.OUTPUT_PATH || path.join(__dirname, "..", "backend", "src", "openapi-generated.json");
...
module.exports = { generateOpenApiSpec, SCHEMAS, PATHS };

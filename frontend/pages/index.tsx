...
export default function Home({ publicKey, onConnect }: HomeProps) {
    ...
    return (
        ...
        <div className="relative overflow-hidden cursor-default select-none">
            {/* <div className="success-confetti relative text-center py-16">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
                ...
                <div className="text-center mb-20 animate-fade-in">
                    ...
                    <p className="text-slate-400 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                        Stellar MicroPay lets anyone send tiny payments across
                        borders instant — for fractions of a cent. No bank. No
                        borders. No friction.
                    </p>
                ...
                <div className="grid grid-cols-3 gap-px bg-stellar-500/10 rounded-2xl overflow-hidden mb-24 border border-stellar-500/15 cursor-default">
                    {STATS.map((stat) => (
                        <div
                            key={stat.label}
                            className="bg-cosmos-900 text-center py-8 px-4"
                        >

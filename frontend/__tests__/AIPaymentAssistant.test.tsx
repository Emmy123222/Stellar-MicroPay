...
describe("AIPaymentAssistant", () => {
  ...
  it("renders when open", () => {
    render(<AIPaymentAssistant isOpen={true} onClose={mockOnClose} onConfirm={mockOnConfirm} />);
  ...
  it("does not render when closed", () => {
    render(<AIPaymentAssistant isOpen={false} onClose={mockOnClose} onConfirm={mockOnConfirm} />);
